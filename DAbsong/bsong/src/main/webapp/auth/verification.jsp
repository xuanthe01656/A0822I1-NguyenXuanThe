	     ...
	     <div class="container">
	        <div class="row">
	           <div class="col-md-5">
	              <!-- Logo -->
	              <div class="logo">
	                 <h1><a href="#">VNE-Verification</a></h1>
	              </div>
	           </div>
	           <div class="col-md-5">
	              <div class="row">
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-wrapper">
			        <div class="box">
			            ...
			            <form autocomplete="on" class="form2" action="<%=request.getContextPath()%>/verification" method="post">
			                ...
			                <%
			                	if(request.getParameter("msg")!=null){
			                		...
			                		if(msg==1){
			                			%>
			                			<p class="error">Sai tên đăng nhập hoặc mật khẩu!!<a href="<%=request.getContextPath() %>/" Style="color: green;">Quên mật khẩu?</a><p>
			                			<%
			                		}else{
			                			if(msg==2){
				                			%>
			                ...
			                <div class="form-group">
			                	<label class="text-left pull-left" for="verification">Mã xác nhận</label>
			               		<input autocomplete="off" class="form-control" type="text" placeholder="Verification" name="verification" >
			                </div>

			                <div class="action">
			                    <button type="submit" class="btn btn-primary signup btn-block" >Xác Nhận</button>
			                </div>  
			             </form>             
			            </div>			           
			        </div>					
