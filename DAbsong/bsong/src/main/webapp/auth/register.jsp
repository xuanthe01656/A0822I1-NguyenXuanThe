			            ...
			            <form autocomplete="on" class="form2" action="<%=request.getContextPath()%>/Login" method="post">
			                ...
			                <%
			                	if(request.getParameter("msg")!=null){
			                		...
			                		if(msg==1){
			                			%>
			                			<p class="error">Sai tên đăng nhập hoặc mật khẩu!!<a href="javascript:void(0)" Style="color: green;">Quên mật khẩu?</a><p>
			                			<%
			                		}else{
			                			if(msg==2){
				                			%>
				                			<p class="error">Tài khoản không tồn tại !!. <a href="javascript:void(0)" Style="color: green;">Tạo tài khoản?</a><p>
				                			<%
				                		}
			                		}
			                	}
			                ...
			                <div class="form-group">
			                 ...
			                 <div class="form-group">
			                	<label class="text-left pull-left" for="password">Nhập lại mật khẩu</label>
			                	<input autocomplete="off" class="form-control" type="password" placeholder="Password" name="password">
			                </div>
