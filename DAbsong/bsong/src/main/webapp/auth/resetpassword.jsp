			            ...
			            <form autocomplete="on" class="form2" action="<%=request.getContextPath()%>/Login" method="post">
			                ...
			                <div class="form-group">
			                	<label class="text-left pull-left" for="password">Mật khẩu mới</label>
			               		<input autocomplete="off" class="form-control" type="text" placeholder="Password" name="password" >
			                </div>
			                
			                <div class="form-group">
			                	<label class="text-left pull-left" for="repassword">Nhập lại mật khẩu</label>
			                	<input autocomplete="off" class="form-control" type="password" placeholder="RePassword" name="repassword">
			                </div>
			                
			                <div class="action">
			                    <button type="submit" class="btn btn-primary signup btn-block" >Confirm</button>
			                </div>  
			             </form>             
			            </div>			           
			        </div>					
